...
.big-warning b {
	...
	<div id="installer-right">
		...
		<ul class="version-history">
			<li><span class="version">Ver</span> 1.49.8</li>
			<li><span class="version-upgraded">Upg</span> Calendar now jumps to the min date when the 'minimum date' Date Modifier is used.</li>
			<li><span class="version-fixed">Fix</span> The 'luhn' Validation Rule should not have been visible.</li>
		</ul>
